		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comui5propertyselection-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comui5propertyselection-display": {
								"semanticObject": "comui5propertyselection",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ui5.propertyselection",
									"url": sap.ui.require.toUrl("com/ui5/propertyselection")
								}
							}
						}
					}
